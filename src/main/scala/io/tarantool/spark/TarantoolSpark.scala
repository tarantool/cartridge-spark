...
object TarantoolSpark {
  ...
  /**
    ...
    */
  def load[T: ClassTag](sparkContext: SparkContext,
                        space: String): TarantoolRDD[T] = {
    load(sparkContext,
         TarantoolConfigBuilder.createReadOptions(space, sparkContext.getConf))
  }
  ...
  /**
    ...
    */
  def load[T: ClassTag](sparkContext: SparkContext,
                        options: ReadOptions): TarantoolRDD[T] = {
  ...
  /**
    ...
    *
    */
  def load[T](sparkContext: JavaSparkContext,
              space: String,
              clazz: Class[T]): TarantoolJavaRDD[T] = {
    load(sparkContext,
         TarantoolConfigBuilder.createReadOptions(space, sparkContext.getConf),
         clazz)
  }
