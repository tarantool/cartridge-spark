...
class TarantoolSparkReadStandaloneClientTest extends FunSuite with Matchers with BeforeAndAfterAll with BeforeAndAfterEach with SharedSparkContextStandaloneClient {
